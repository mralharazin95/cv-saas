    ...
    >
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden gradient-primary">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
          ...
          <h1 className="text-4xl font-bold mb-4 text-center">ResumeX</h1>
          <p className="text-lg text-white/80 text-center max-w-md">
            Build stunning, professional resumes in minutes with our AI-powered builder
          </p>
          <div className="mt-12 grid grid-cols-3 gap-6 text-center">
            {[
              { val: "5+", label: "Templates" },
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p style={{ color: "var(--text-secondary)" }}>{t("login_subtitle")}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              disabled={loading}
              id="login-submit"
              className="w-full py-3.5 rounded-xl text-white font-semibold gradient-primary transition-all hover:shadow-lg hover:scale-[1.02] disabled:opacity-50 disabled:scale-100 flex items-center justify-center gap-2"
            >
              {loading ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-medium transition-all hover:scale-[1.02]"
              style={{
                background: "var(--bg-secondary)",
                border: "1px solid var(--border-primary)",
                color: "var(--text-primary)",
